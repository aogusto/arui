...
export default function Example() {
  return (
    <ResizablePanelGroup className="h-72 w-full max-w-lg rounded-xl border border-separator">
      ...
      <ResizableHandle withHandle />
      <ResizablePanel defaultSize="25">
        <div className="flex h-full items-center justify-center p-6 text-body text-label">Three</div>
      </ResizablePanel>
    </ResizablePanelGroup>
  )
}
