...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex size-full flex-col overflow-hidden rounded-xl! bg-popover in-data-[slot=dialog-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent p-1 text-popover-foreground",
        className
      )}
      {...props}
    />
